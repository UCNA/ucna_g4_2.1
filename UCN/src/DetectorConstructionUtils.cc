...
using namespace std;	// for the Append method
...
MaterialUser::MaterialUser()
{
  ...
  if(isConstructed == true)	// once a single object makes these elements, get out
    return;
...
{
  // below is Michael Mendenhall's comment
...
string MaterialUser::Append(int i, string str)
{
